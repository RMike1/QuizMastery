<template>
      <Transition name="modal">
            <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                  <!-- Backdrop -->
                  <div class="fixed inset-0 bg-transparent backdrop-blur-lg" @click="quizStore.hideQuizSection"></div>

                  <!-- Modal Content -->
                  <div class="relative w-full mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16 max-w-[95vw] sm:max-w-[90vw] md:max-w-[85vw] lg:max-w-7xl bg-transparent/80 backdrop-blur-md rounded-t-[10px] sm:rounded-t-[20px] lg:rounded-t-[30px] shadow-[0_0_40px_rgba(74,222,128,0.1)] sm:shadow-[0_0_60px_rgba(74,222,128,0.15)] lg:shadow-[0_0_80px_rgba(74,222,128,0.15)] overflow-hidden transform transition-all border-2 border-[#2a2a2a]/30 hover:shadow-[0_0_60px_rgba(74,222,128,0.2)] sm:hover:shadow-[0_0_80px_rgba(74,222,128,0.25)] lg:hover:shadow-[0_0_100px_rgba(74,222,128,0.25)]">
                        <!-- Glow Effect -->
                        ...
                        <div class="relative overflow-hidden">
                              ...
                              <!-- Progress Steps -->
                              <div class="px-6 py-4 bg-gray-50/80 dark:bg-gray-900/50 backdrop-blur-md">
                                                ...
                                                <button @click="quizStore.setCurrentIndex(i)"
                                                      ...
                                                      :class="[
                                                            ...
                                                            i === quizStore.currentIndex 
                                                                  ? 'border-gray-900 bg-gray-900 dark:border-white dark:bg-white scale-110' 
                                                      ...
                                                      <span :class="[
                                                            ...
                                                            i === quizStore.currentIndex 
                                                                  ? 'text-white dark:text-gray-900 text-lg' 
                                                                  : quizStore.selectedAnswers[quizStore.level[quizStore.currentLevelValue]?.questions[i]?.id] !== undefined
                                                      ...
                                                      <!-- Highlight Effect -->
                                                      <span class="absolute inset-0 rounded-xl bg-gray-100 dark:bg-gray-800/40 transform scale-0 transition-transform duration-200 ease-out group-hover:scale-100 -z-10"></span>
                                                </button>
                        ...
                        <!-- Footer -->
                        <div class="px-6 py-4 bg-gray-50 dark:bg-[#111] border-t border-gray-200 dark:border-gray-800/50">
                              <div class="flex items-center justify-between gap-4">
                                    ...
                                    <button @click="quizStore.previousQuestion()"
                                          ...
                                          <!-- Button Background -->
                                          <div class="absolute inset-0 bg-gray-100 dark:bg-[#111]/50 opacity-100 group-hover:opacity-0 transition-opacity"></div>
                                          <div class="absolute inset-0 bg-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                          
                                          <!-- Button Content -->
                                          <span class="relative flex items-center gap-2 text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                                    ...
                                    <button v-if="quizStore.currentIndex + 1 < quizStore.currentLevelTotalQuestions"
                                          ...
                                          <!-- Button Background -->
                                          <div class="absolute inset-0 bg-transparent opacity-100 group-hover:opacity-90 transition-opacity"></div>
                                          
                                          <!-- Button Content -->
                                          <span class="relative flex items-center gap-2 text-gray-900 dark:text-white">
                                                Next
                                                <svg class="w-5 h-5 transition-transform duration-200 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                          ...
                                          <!-- Button Glow Effect -->
                                          <div class="absolute inset-0 w-full h-full transition-all duration-300 opacity-0 group-hover:opacity-20 bg-transparent"></div>
                                    </button>
